...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget buildStatsWidget() {
    ...
    if (sport == 'Cricket') {
      statsWidgets = [
        StatItem(value: userStats?['Runs'].toString() ?? '-', label: 'Total Runs'),
        VerticalDivider(),
        StatItem(value: userStats?['MatchesPlayed'].toString() ?? '-', label: 'Matches'),
        VerticalDivider(),
        StatItem(value: userStats?['Hundreds'].toString() ?? '-', label: '100s'),
      ];
    } else if (sport == 'Basketball') {
      statsWidgets = [
        StatItem(value: userStats?['Points'].toString() ?? '-', label: 'Points'),
        VerticalDivider(),
        StatItem(value: userStats?['Assists'].toString() ?? '-', label: 'Assists'),
        VerticalDivider(),
        StatItem(value: userStats?['Rebounds'].toString() ?? '-', label: 'Rebounds'),
      ];
    }
